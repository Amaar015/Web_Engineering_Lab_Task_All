...
if($result=mysqli_query($conn,$record)){
    if(mysqli_num_rows($result)>0){
          while($getProduct=mysqli_fetch_array($result)){
            echo '<div class="card">';
            echo "<div class='card-img'>";
            echo "<img src='images/" . $getProduct['image'] . "' alt='" . $getProduct['name'] . "' class='card-imgs'>";
            echo "</div>";
            echo "<div class='card-info'>";
            echo  "<p class='text-title'>".$getProduct['name']."</p>";
            echo "<p class='text-body'>" . $getProduct['description']."</p>";
            echo "</div>";
            echo "<div class='card-footer'>";
            echo "<span class='text-title'>".$getProduct['price']."</span>" ;
